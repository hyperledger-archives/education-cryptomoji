...
first install [Node 8](https://nodejs.org/) or higher, then from your terminal
run:
...
not all, blockchains. First, a _private key_ is generated, basically just a
random set of bytes. This key is kept secret. Then, a cryptographic algorithm
...
best bet is probably to familiarize yourself with Node's crypto module, in
...
you recreate the hashes and make sure they match, and of course, the chain of
previousHashes should be unbroken all the way back to your genesis block.
